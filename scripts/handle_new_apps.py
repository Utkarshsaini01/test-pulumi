...
def main():
    ...
    # Always resolve repo root based on location of this script
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for app_name in new_app_names:
            ...
            if (repo_root / "pyproject.toml").exists():
                ...
                run(f'python new_app.py -a {app_name} -e {envs_arg}', cwd=str(repo_root / "scripts"))
            ...
            run(f'python new_app.py -a {app_name} -e {envs_arg}', cwd=str(tmp_infra / "scripts"))
